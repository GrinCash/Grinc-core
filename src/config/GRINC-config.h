/* src/config/GRINC-config.h.  Generated from GRINC-config.h.in by configure.  */
/* src/config/GRINC-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef GRINC_CONFIG_H

#define GRINC_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.GRINC.me"

/* Define to the full name of this package. */
#define PACKAGE_NAME "GRINC Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "GRINC Core 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "GRINC"
