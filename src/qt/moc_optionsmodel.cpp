...
QT_MOC_LITERAL(7, 108, 27), // "anonymizeGRINCAmountChanged"
...
QT_MOC_LITERAL(10, 187, 18) // "hideOrphansChanged"
    ...
    "preferredDenomChanged\0anonymizeGRINCAmountChanged\0"
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->anonymizeGRINCAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (OptionsModel::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OptionsModel::anonymizeGRINCAmountChanged)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void OptionsModel::anonymizeGRINCAmountChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
