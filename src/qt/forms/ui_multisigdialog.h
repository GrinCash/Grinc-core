...
public:
    ...
    void setupUi(QDialog *MultisigDialog)
    {
        ...
        multisigTabWidget->setStyleSheet(QStringLiteral("QScrollArea{border: 1px solid #000000;}"));
        ...
        addAddressWidget->setGeometry(QRect(0, 0, 759, 194));
        ...
        txInputsWidget->setGeometry(QRect(0, 0, 747, 142));
        ...
        destinationsScrollAreaContents->setGeometry(QRect(0, 0, 747, 141));
...
"}"));
        ...
        keyScrollAreaContents->setGeometry(QRect(0, 0, 755, 181));
...
#ifndef QT_NO_TOOLTIP
        addDestinationButton->setToolTip(QApplication::translate("MultisigDialog", "Add destinations to send GRINC to", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
