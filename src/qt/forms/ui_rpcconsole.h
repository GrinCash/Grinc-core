...
public:
    ...
    QLabel *wallet_customzGRINCbackuppath_label;
    QLabel *wallet_customzGRINCbackuppath;
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        wallet_customzGRINCbackuppath_label = new QLabel(tab_repair);
        wallet_customzGRINCbackuppath_label->setObjectName(QStringLiteral("wallet_customzGRINCbackuppath_label"));
        wallet_customzGRINCbackuppath_label->setVisible(false);

        gridLayout_4->addWidget(wallet_customzGRINCbackuppath_label, 4, 0, 1, 1);

        wallet_customzGRINCbackuppath = new QLabel(tab_repair);
        wallet_customzGRINCbackuppath->setObjectName(QStringLiteral("wallet_customzGRINCbackuppath"));
        wallet_customzGRINCbackuppath->setCursor(QCursor(Qt::IBeamCursor));
        wallet_customzGRINCbackuppath->setTextFormat(Qt::PlainText);
        wallet_customzGRINCbackuppath->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);
        wallet_customzGRINCbackuppath->setVisible(false);

        gridLayout_4->addWidget(wallet_customzGRINCbackuppath, 4, 1, 1, 3);
    ...
    void retranslateUi(QDialog *RPCConsole)
    {
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the GRINC debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        wallet_customzGRINCbackuppath_label->setText(QApplication::translate("RPCConsole", "Custom zGRINC Backup Path:", Q_NULLPTR));
        wallet_customzGRINCbackuppath->setText(QApplication::translate("RPCConsole", "N/A", Q_NULLPTR));
