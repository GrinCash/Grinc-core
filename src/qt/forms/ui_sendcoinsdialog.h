...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 GRINC"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 GRINC"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 944, 116));
        ...
        checkzGRINC = new QCheckBox(frame_Send);
        checkzGRINC->setObjectName(QStringLiteral("checkzGRINC"));
        checkzGRINC->setEnabled(false);

        horizontalLayout_2->addWidget(checkzGRINC);
        ...
        labelBalance->setText(QStringLiteral("123.456 GRINC"));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelBlockSize->setText(QApplication::translate("SendCoinsDialog", "0 GRINC", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkSwiftTX->setToolTip(QApplication::translate("SendCoinsDialog", "SwiftX technology allows for near instant transactions - A flat fee of 0.01 GRINC applies", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        radioCustomPerKilobyte->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uGRINCs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uGRINCs in fee,<br />while \"at least\" pays 1000 uGRINCs. For transactions bigger than a kilobyte both pay by kilobyte.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        radioCustomPerKilobyte->setText(QApplication::translate("SendCoinsDialog", "per kilobyte", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        radioCustomAtLeast->setToolTip(QApplication::translate("SendCoinsDialog", "If the custom fee is set to 1000 uGRINCs and the transaction is only 250 bytes, then \"per kilobyte\" only pays 250 uGRINCs in fee,<br />while \"total at least\" pays 1000 uGRINCs. For transactions bigger than a kilobyte both pay by kilobyte.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        radioCustomAtLeast->setText(QApplication::translate("SendCoinsDialog", "total at least", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkBoxMinimumFee->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for GRINC transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxMinimumFee->setText(QString());
#ifndef QT_NO_TOOLTIP
        labelMinFeeWarning->setToolTip(QApplication::translate("SendCoinsDialog", "Paying only the minimum fee is just fine as long as there is less transaction volume than space in the blocks.<br />But be aware that this can end up in a never confirming transaction once there is more demand for GRINC transactions than the network can process.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        checkzGRINC->setText(QApplication::translate("SendCoinsDialog", "Anonymized GRINC", Q_NULLPTR));
